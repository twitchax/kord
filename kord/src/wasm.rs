...
mod tests {
    ...
    fn test_scale_candidates_basic() {
        ...
        let first_candidate: KordScaleCandidate = first.unchecked_into().unwrap();
    ...
    fn test_scale_candidates_minor_chord() {
        ...
        for i in 0..candidates.length() {
            ...
            let candidate: KordScaleCandidate = candidate_val.unchecked_into().unwrap();
    ...
    fn test_scale_candidates_with_different_roots() {
        ...
        let c_first: KordScaleCandidate = c_candidates.get(0).unchecked_into().unwrap();
        let g_first: KordScaleCandidate = g_candidates.get(0).unchecked_into().unwrap();
