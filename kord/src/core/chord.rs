...
pub trait ToMode {
    ...
    fn to_mode(&self) -> Option<crate::core::mode::Mode>;
}
...
impl ToMode for Chord {
    fn to_mode(&self) -> Option<crate::core::mode::Mode> {
        use crate::core::mode::{ModeKind, Mode};
