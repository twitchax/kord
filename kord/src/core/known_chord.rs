...
impl HasDescription for KnownChord {
    fn description(&self) -> &'static str {
        match self {
            ...
            KnownChord::Major => "major, ionian mode",
            KnownChord::Minor => "minor, aeolian mode",
            KnownChord::Major7 => "major 7, ionian mode, first mode of major scale",
            KnownChord::Dominant(_) => "dominant, mixolydian mode, fifth mode of major scale, major with flat seven",
            KnownChord::MinorMajor7 => "minor major 7, melodic minor, first mode of melodic minor scale, major with flat third",
            KnownChord::MinorDominant(_) => "minor 7, dorian mode, second mode of major scale, major with flat third and flat seven",
            KnownChord::DominantSharp11(_) => "dominant sharp 11, lydian dominant mode, fourth mode of melodic minor, major with sharp four and flat seven",
            KnownChord::Augmented => "augmented, major with sharp five",
            KnownChord::AugmentedMajor7 => "augmented major 7, lydian augmented mode, third mode of melodic minor, major with sharp four and five",
            KnownChord::AugmentedDominant(_) => "augmented dominant, whole tone",
            KnownChord::HalfDiminished(_) => "half diminished, locrian mode, minor seven flat five, seventh mode of major scale, major scale starting one half step up",
            KnownChord::Diminished => "fully diminished (whole first), diminished seventh, whole/half/whole diminished",
            KnownChord::DominantFlat9(_) => "dominant flat 9, phrygian dominant mode, fifth mode of harmonic minor, fully diminished (half first), half/whole/half diminished",
            KnownChord::DominantSharp9(_) => "dominant sharp 9, altered mode, altered dominant, super locrian, seventh mode of melodic minor scale, melodic minor up a half step",
            KnownChord::MinorDominantFlat13(_) => "minor dominant flat 13, aeolian mode, sixth mode of major scale",
            KnownChord::MinorDominantFlat9Flat13(_) => "minor dominant flat 9 flat 13, phrygian mode, third mode of major scale",
            KnownChord::Sharp11 => "sharp 11, lydian mode, fourth mode of major scale",
        }
    }
}
